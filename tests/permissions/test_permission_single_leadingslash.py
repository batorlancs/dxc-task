...
class TestPermissionSingleLeadingslash:
    ...
    async def test_permission_single_leadingslash_access_to_apis(self, api_url, permission, expected_status_code, expected_response):
